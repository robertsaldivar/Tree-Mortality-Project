...
drought_function <- function(input_data, ti = 24, WD = 0.946, SLA = 7.39, coeff1 = -1.28, coeff2 = 0.38, coeff3 = -0.41) {
  #input_data is the precipitation minus potential evapotranspiration for the prior 24 months
  
  SPEI = SPEI::spei(data = input_data, scale = ti)
